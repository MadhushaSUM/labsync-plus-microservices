...
public class DoctorService {
    ...
    public ResponseEntity<List<Doctor>> searchDoctorsByName(String query) {
        try {
            System.out.println("doc");
            return new ResponseEntity<>(doctorDao.findByNameContainingIgnoreCase(query), HttpStatus.OK);
        } catch (Exception e) {
            System.err.println("Error while getting searched doctor data");
            e.printStackTrace();
